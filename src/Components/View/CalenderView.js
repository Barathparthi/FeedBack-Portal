...
const CalenderView = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/auth4/group",
        formData
      );
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/auth4/academic")
      .then((response) => {
    ...
    // Fetch Degrees
    axios
      .get("http://localhost:5000/auth4/degree")
      .then((response) => {
    ...
    // Fetch Term
    axios
      .get("http://localhost:5000/auth4/term")
      .then((response) => {
    ...
    // Fetch Course
    axios
      .get("http://localhost:5000/auth4/courses")
      .then((response) => {
    ...
    // Fetch Staff
    axios
      .get("http://localhost:5000/auth4/search/staff")
      .then((response) => {
  ...
  const fetchPrograms = (degreeId) => {
    axios
      .get(`http://localhost:5000/auth4/program/${degreeId}`)
      .then((response) => {
  ...
  const fetchYears = (degreeId) => {
    axios
      .get(`http://localhost:5000/auth4/year/${degreeId}`)
      .then((response) => {
  ...
  const fetchSemesters = (yearId) => {
    axios
      .get(`http://localhost:5000/auth4/semester/${yearId}`)
      .then((response) => {
