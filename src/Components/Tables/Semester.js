...
const Semester = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSuccessMsg("Semester registered successfully!");
      setTimeout(() => {
      ...
      if (error.response && error.response.status === 409) {
        ...
        setErrorMsg("Failed to register Semester. Please try again!");
      }
      setTimeout(clearMessages, 5000); // Clear message after 10 seconds
    } finally {
      setLoader(false);
          ...
          <div className="d-flex justified-content-center align-items-center mt-3">
            ...
            >
              ...
              <Typography variant="h6" color="text.primary" align="center">
                Please Enter Semester Details in the below Textfield!...
              </Typography>
              <Box
                component="form"
                noValidate
